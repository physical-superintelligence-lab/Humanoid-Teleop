...
class BaseArmController:
    ...
    def gradually_set_weight_to_0(self):
        for i in range(100, 0, -1):
            self.msg.motor_cmd[29].q = i / 100
            self.msg.motor_cmd[30].q = i / 100
            self.msg.motor_cmd[31].q = i / 100
            self.msg.motor_cmd[32].q = i / 100
            self.msg.motor_cmd[33].q = i / 100
            self.msg.motor_cmd[34].q = i / 100
            time.sleep(0.01)
