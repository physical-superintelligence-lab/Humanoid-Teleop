...
from robot_control.robot_hand import InspireController
from robot_control.unitree_hand import Dex3_1_Controller
...
class RobotTaskmaster:
    def __init__(
        ...
        try:
            if robot == "g1":
                ...
                self.hand_ctrl = InspireController()
    ...
    def setHandMotors(self, right_qpos, left_qpos):
        if right_qpos is not None and left_qpos is not None:
            ...
            self.hand_ctrl.ctrl(right_hand_angles, left_hand_angles)
