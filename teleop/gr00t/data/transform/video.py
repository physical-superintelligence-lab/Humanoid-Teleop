...
from typing import Any, Callable, ClassVar, Literal, Optional, Tuple, Union
...
class VideoTransform(ModalityTransform):
    ...
    # Model variables
    _train_transform: Optional[Callable] = PrivateAttr(default=None)
    _eval_transform: Optional[Callable] = PrivateAttr(default=None)
    ...
    def eval_transform(self, value: Optional[Callable]):
    ...
    def get_transform(self, mode: Literal["train", "eval"] = "train") -> Optional[Callable]:
...
class VideoCrop(VideoTransform):
    height: Optional[int] = Field(default=None, description="The height of the input image")
    width: Optional[int] = Field(default=None, description="The width of the input image")
    scale: float = Field(
        ...,
...
class VideoRandomRotation(VideoTransform):
    degrees: Union[float, Tuple[float, float]] = Field(
...
class VideoColorJitter(VideoTransform):
    brightness: Union[float, Tuple[float, float]] = Field(
        ..., description="The brightness of the color jitter"
    )
    contrast: Union[float, Tuple[float, float]] = Field(
        ..., description="The contrast of the color jitter"
    )
    saturation: Union[float, Tuple[float, float]] = Field(
        ..., description="The saturation of the color jitter"
    )
    hue: Union[float, Tuple[float, float]] = Field(..., description="The hue of the color jitter")
